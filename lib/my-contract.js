...
class MyContract extends Contract {
  ...
  async submitPackingList(ctx, grower, trader, PL_Invoice_no, PL_IssueDate, PL_ICO_no,
    ...
    console.log(grower)
    console.log(trader)
    console.log(PL_Invoice_no)
    console.log(PL_IssueDate)
    console.log(PL_ICO_no)
    console.log(PL_ICO_Lot)
    console.log(PL_FDA_NO)
    console.log(PL_Bill_of_Lading_No)
    console.log(PL_LoadedVessel)
    console.log(PL_Container_No)
    console.log(PL_Seal_no)
    console.log(PL_timestamp)
    console.log(batchId)
